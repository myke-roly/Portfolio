...
import { SiJavascript, SiNodeDotJs, SiStyledComponents, SiSass, SiReact, SiMysql, SiMongodb, SiNextDotJs, SiTypescript } from 'react-icons/si';
...
const DATA: Array<{}> = [
  ...
  { id: 7, logo: SiNextDotJs, color: '#087BAA', description: 'All in one place' },
  ...
  { id: 8, logo: SiTypescript, color: '#087BAA', description: 'Super power for javascript' },
];
